function [receivers, transmitters, parameters] = validate_parameters(receivers, transmitters, input_parameters, model_name, varargin)
...
parameters.propagation_model = propagation_model_selector(model_name);
