...
fmin = tx_model.minimum_frequency;
fmax = tx_model.maximum_frequency;
Nfrequencies = tx_model.frequency_division_number;
frequency = mean([fmin,fmax]);
...
if strcmp(tx_model.name, 'UMA')
    ...
    channel_frequencies = transmitters_frequencies_distributer(latitudes,longitudes,fmin,fmax,Nfrequencies);
    channel_frequencies = repelem(channel_frequencies,3);
