...
% the MIMO channel matrix between each transmitter and receiver. Using it,
% compute the maximum capacity for each link Tx-Rx.
...
capacity_matrix = BW*capacity_matrix;                                                                   % Final bit-rate of each link (Mbps).
end
