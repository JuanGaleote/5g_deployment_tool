function [sinr_matrix] = get_sinr_matrix_for_all_the_transmitters(receivers, transmitters, model_name, varargin)
...
for rxInd = 1:validated_params.numRxs
    for txInd = 1:number_of_transmitters
        ...
        %Calculo de la potencia de la señal fuente
        sigSourceInd = txInd;
        ...
        %Cálculo de la potencia Interferencia
